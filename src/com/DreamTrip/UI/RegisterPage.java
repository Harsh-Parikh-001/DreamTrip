...
public class RegisterPage implements Initializable
{
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		navigation_bt.setOnMouseClicked(this:: handle);
	}
...
//		try
//		{
//			final int i = ConnectionClass.insertCustomer(name_tf.getText(), contact_tf.getText(), email_tf.getText(), address_tf.getText(), psswd, key);
//			if (i == 1)
//			{
